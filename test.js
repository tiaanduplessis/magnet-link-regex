...
const magnetLinkRegex = require('./')

test('should export a regex', () => {
  expect(magnetLinkRegex).toBeDefined()
  expect(magnetLinkRegex() instanceof RegExp).toBeTruthy()
})

test('should match valid magnet url', () => {
  const urls = [
  ...
  urls.forEach(url => {
    expect(pattern.test(url)).toBeTruthy()
  })
})
